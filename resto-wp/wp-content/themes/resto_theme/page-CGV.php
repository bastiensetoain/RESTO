<?php get_header(); ?>
	...
	<div class="head"></div>
		<main>
                ...
                <?php while ( have_posts() ) : the_post(); ?> <!--Because the_content() works only inside a WP Loop -->
                        <div class="pre_page">
                            <h1><?php the_title(); ?></h1>
                            <p class="text_parcours"><span class="marks">"</span><?php the_content(); ?><span class="marks">"</span></p>
                ...
                <div class="bulles_parcours">
                    <div class="first_line">
                        <?php
                            $loop = new WP_Query( array( 'post_type' => 'parcours_post', 'posts_per_page' => 3, 'order' => 'DESC' ) );
    ...
    top: -40px;}</style>
                  ...
                  <div class="second_line">
                        <?php
                            $loop = new WP_Query( array( 'post_type' => 'parcours_post', 'posts_per_page' => 2, 'order' => 'ASC' ) );
                            while ( $loop->have_posts() ) : $loop->the_post(); ?>
